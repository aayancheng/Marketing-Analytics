import { BarChart3, TrendingUp, SlidersHorizontal, PieChart, Menu, X } from 'lucide-react';

const NAV_ITEMS = [
  { id: 'decomposition', label: 'Decomposition', icon: BarChart3 },
  { id: 'performance', label: 'Channel Performance', icon: TrendingUp },
  { id: 'simulator', label: 'Budget Simulator', icon: SlidersHorizontal },
  { id: 'allocation', label: 'Optimal Allocation', icon: PieChart },
];
    ...
    <>
      ...
      >
        <div className="px-5 py-6">
          ...
          <p className="text-xs text-brand-300 mt-1">Marketing Mix Model</p>
        </div>
